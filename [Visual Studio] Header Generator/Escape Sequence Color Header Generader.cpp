...
const int numForegroundColors = 9;
const int numBackgroundColors = 9;
...
const string TA_Attributes_offTxt = "ATTRIBUTES_OFF";
...
void streamToOutput( bool withTag, ofstream &output );

void streamToOutput( bool withTag, ofstream &output )
{
	//====================================//
	//  Stand Alone Text Attributes
	//====================================//
...
int _tmain( int argc, _TCHAR* argv[] )
{
	...
	output << "/*!" << endl
		<< "* # Escape-Sequence-Color-Header" << endl
		<< "* Color Your Output in Unix!!" << endl
		<< "* " << endl
		<< "* " << endl
		<< "* ##File:" << endl
		...
		<< "* ##Format:" << endl
		<< "* " << endl
		<< "* General Format, include value you want in $variable$" << endl
		<< "* " << endl
		...
		<< "* ##Usage:" << endl
		<< "* " << endl
		<< "* Just use  to stream the color you want before outputting text and" << endl
		<< "* use  again to set the color to normal after outputting text." << endl
		<< "* " << endl
		<< "* cout << COLOR_BLUE_BLACK << \"TEXT\" << COLOR_NORMAL << endl;" << endl
		<< "* cout << COLOR_BOLD_YELLOW_CYAN << \"TEXT\" << COLOR_NORMAL << endl;" << endl
		<< "* */" << endl;

	output << "const char COLOR_NORMAL[] = { 0x1b, '[', '0', ';', '3', '9', 'm', 0 };" << endl;
	output << "const char COLOR_NORMAL_COLOREND[] = { 0x1b, '[', '0', ';', '3', '9', 'm', 0 };" << endl;

	bool withTag = false;
	streamToOutput( withTag, output );
	withTag = true;
	streamToOutput( withTag, output );
	return 0;
}